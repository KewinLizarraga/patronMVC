...
<div class="container">
    ...
    <br>
     <label for="usr">RESULTADOS TOTALES</label>
     <div class="row">
      <br>
      <div class="col-sm-4">
        <label for="usr">SUBTOTAL</label>
        <input type="text" class="form-control" id="subtotal" reandoly>
        <p>
        <div class="form-check">
        <input type="checkbox" class="form-checck-input" id="descuento" onclick="descontar();">
        <label class="from-check-label" for="exampleCheck1">DESCUENTO</label>
     </div>

     </div>

     <div class="col-sm-4">
        <label for="usr">IGV</label>
        <input type="text" class="form-control" id="igv" reandoly>
     </div>
     <div class="col-sm-4">
        <label for="usr">TOTAL</label>
        <input type="text" class="form-control" id="total" reandoly>
     </div>
 </div>  
